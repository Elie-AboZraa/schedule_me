...
List<Widget> ListViewFromFiles(BuildContext context ,List<File> file_list, String empty_message) {
  ...
  if (file_list.isEmpty) {
    ...
    tmp_Widget_list.add(ScheduleFileCard(fileName: file.path.split('/').last, onTap: ()=>Navigator.of(context).push(createRoute(selection: "CreateSchedules", data: file))));
    }
